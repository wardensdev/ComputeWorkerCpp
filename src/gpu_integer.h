#ifndef GPU_INTEGER_CLASS_H
#define GPU_INTEGER_CLASS_H
...
class GPU_Integer : public GPUUniform
{
    GDCLASS(GPU_Integer, GPUUniform);
    ...
    public:
        ...
        PackedByteArray int_to_byte_array(int value);
        int byte_array_to_int(PackedByteArray bytes);
